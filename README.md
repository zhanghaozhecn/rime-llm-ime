...
| 自动回退 | 光标文本采集不可用的应用（WPS 表格编辑态为 COM 盲区、部分 32 位应用）自动改用上屏历史，功能等价 |
...
> 与 [rime-llm-rerank](https://github.com/zhanghaozhecn/rime-llm-rerank)（插件版）功能等效，二选一；本版 TSF 采集 + COM 旁路，插件版 COM + UIA TextPattern + 历史三层。
